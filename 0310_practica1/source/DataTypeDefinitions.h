/**
	\file
	Descripción: Este es el archivo header que contiene todas las definiciones de los tipos de datos que
					utilizaremos en todos los drivers, modulos y aplicaciones.
